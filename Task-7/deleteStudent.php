            ...
            <div class="col-md-8 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3 style="color: #b31d12;">Are you want to delete a student?</h3>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="code.php" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="firstName" value="<?= $student->first_name?>" class="form-control" readonly>
                            </div>

                            <div class="mb-3">
                                <label>Last Name</label>
                                <input type="text" name="lastName" value="<?= $student->last_name?>" class="form-control" readonly>
                            </div>
